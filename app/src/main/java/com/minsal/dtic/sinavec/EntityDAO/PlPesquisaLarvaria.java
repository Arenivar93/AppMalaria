 ...
 */
@Entity(active = true)
public class PlPesquisaLarvaria implements Serializable {
    ...
    @Generated
    public PlPesquisaLarvaria(Long id, int idSemanaEpidemiologica, int idUsuarioMod, int idEstado, java.util.Date fechaHoraReg, java.util.Date fechaHoraMod, float indiceLarvario, int anophelesDos, int anophelesUno, int culicinosUno, int culicinosDos, int pupa, int numeroCucharonada, float ancho, float largo, java.util.Date fecha, long idTablet, long idSibasi, long idCriadero, long idCaserio, long idUsuarioReg) {
        this.id = id;
