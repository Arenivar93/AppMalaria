 ...
 */
public class editarCriaderoDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final View v = inflater.inflate(R.layout.dialog_editar_criadero, null);
        ...
        if(criadero.getIdTipoCriadero()==1){
            spTipoCriadero.setSelection(1);
        }else{
            spTipoCriadero.setSelection(2);
        }

        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
        builder.setView(v);
        builder.setTitle("Editar criadero:");
                ...
                btnCrear.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if(error==0){
                            ...
                            mListener.onDialogPositiveClick(editarCriaderoDialogFragment.this,nombreVal,descripcionVal,tipoCriaderoVal,anchoVal,largoVal);
                            ventana.dismiss();
                        }
                    }
                });
