...
public class PlGotaGruesaDao extends AbstractDao<PlGotaGruesa, Long> {
    ...
    public static class Properties {
        ...
        public final static Property IdTablet = new Property(24, long.class, "idTablet", false, "ID_TABLET");
        public final static Property IdSibasi = new Property(25, long.class, "idSibasi", false, "ID_SIBASI");
        public final static Property IdCaserio = new Property(26, long.class, "idCaserio", false, "ID_CASERIO");
        public final static Property IdUsuarioReg = new Property(27, long.class, "idUsuarioReg", false, "ID_USUARIO_REG");
        public final static Property IdClave = new Property(28, long.class, "idClave", false, "ID_CLAVE");
        public final static Property IdPais = new Property(29, long.class, "idPais", false, "ID_PAIS");
        public final static Property IdResultado = new Property(30, long.class, "idResultado", false, "ID_RESULTADO");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"PL_GOTA_GRUESA\" (" + //
                ...
                "\"ID_TABLET\" INTEGER NOT NULL ," + // 24: idTablet
                "\"ID_SIBASI\" INTEGER NOT NULL ," + // 25: idSibasi
                "\"ID_CASERIO\" INTEGER NOT NULL ," + // 26: idCaserio
                "\"ID_USUARIO_REG\" INTEGER NOT NULL ," + // 27: idUsuarioReg
                "\"ID_CLAVE\" INTEGER NOT NULL ," + // 28: idClave
                "\"ID_PAIS\" INTEGER NOT NULL ," + // 29: idPais
    ...
    protected final void bindValues(DatabaseStatement stmt, PlGotaGruesa entity) {
        ...
        stmt.bindLong(25, entity.getIdTablet());
        stmt.bindLong(26, entity.getIdSibasi());
        stmt.bindLong(27, entity.getIdCaserio());
        stmt.bindLong(28, entity.getIdUsuarioReg());
        stmt.bindLong(29, entity.getIdClave());
        stmt.bindLong(30, entity.getIdPais());
        stmt.bindLong(31, entity.getIdResultado());
    }
    ...
    public PlGotaGruesa readEntity(Cursor cursor, int offset) {
        PlGotaGruesa entity = new PlGotaGruesa( //
            ...
            cursor.getLong(offset + 24), // idTablet
            cursor.getLong(offset + 25), // idSibasi
            cursor.getLong(offset + 26), // idCaserio
            cursor.getLong(offset + 27), // idUsuarioReg
            cursor.getLong(offset + 28), // idClave
            cursor.getLong(offset + 29), // idPais
            cursor.getLong(offset + 30) // idResultado
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, PlGotaGruesa entity, int offset) {
        ...
        entity.setIdTablet(cursor.getLong(offset + 24));
        entity.setIdSibasi(cursor.getLong(offset + 25));
        entity.setIdCaserio(cursor.getLong(offset + 26));
        entity.setIdUsuarioReg(cursor.getLong(offset + 27));
        entity.setIdClave(cursor.getLong(offset + 28));
        entity.setIdPais(cursor.getLong(offset + 29));
        entity.setIdResultado(cursor.getLong(offset + 30));
     }
