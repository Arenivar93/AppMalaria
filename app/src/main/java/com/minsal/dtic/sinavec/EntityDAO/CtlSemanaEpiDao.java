...
public class CtlSemanaEpiDao extends AbstractDao<CtlSemanaEpi, Long> {
    ...
    public static class Properties {
        ...
        public final static Property FechaInicio = new Property(3, java.util.Date.class, "fechaInicio", false, "FECHA_INICIO");
        public final static Property FechaFin = new Property(4, java.util.Date.class, "fechaFin", false, "FECHA_FIN");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CTL_SEMANA_EPI\" (" + //
                ...
                "\"FECHA_INICIO\" INTEGER," + // 3: fechaInicio
                "\"FECHA_FIN\" INTEGER);"); // 4: fechaFin
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, CtlSemanaEpi entity) {
        ...
        java.util.Date fechaInicio = entity.getFechaInicio();
        if (fechaInicio != null) {
            stmt.bindLong(4, fechaInicio.getTime());
        }
 
        java.util.Date fechaFin = entity.getFechaFin();
        if (fechaFin != null) {
            stmt.bindLong(5, fechaFin.getTime());
        }
    }
    ...
    public CtlSemanaEpi readEntity(Cursor cursor, int offset) {
        CtlSemanaEpi entity = new CtlSemanaEpi( //
            ...
            cursor.isNull(offset + 3) ? null : new java.util.Date(cursor.getLong(offset + 3)), // fechaInicio
            cursor.isNull(offset + 4) ? null : new java.util.Date(cursor.getLong(offset + 4)) // fechaFin
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, CtlSemanaEpi entity, int offset) {
        ...
        entity.setFechaInicio(cursor.isNull(offset + 3) ? null : new java.util.Date(cursor.getLong(offset + 3)));
        entity.setFechaFin(cursor.isNull(offset + 4) ? null : new java.util.Date(cursor.getLong(offset + 4)));
     }
