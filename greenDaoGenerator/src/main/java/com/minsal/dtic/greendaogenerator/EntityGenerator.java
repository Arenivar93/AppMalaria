...
public class EntityGenerator {
    public static void main(String[] args) {
       ...
       // addTables(schema);
        ...
        plGotaGruesa.addStringProperty("primerNombre").notNull();
        ...
        plGotaGruesa.addStringProperty("fechaHoraMod");
        plGotaGruesa.addStringProperty("fecha");
        ...
        plGotaGruesa.addStringProperty("detalleLectura");
        plGotaGruesa.addIntProperty("estado_sync").notNull();
        plGotaGruesa.addIntProperty("unidadEdad").notNull();
        plGotaGruesa.addStringProperty("responsable");
        plGotaGruesa.addStringProperty("segundoNombre");
        plGotaGruesa.addStringProperty("primerApellido").notNull();
        plGotaGruesa.addStringProperty("segundoApellido");
